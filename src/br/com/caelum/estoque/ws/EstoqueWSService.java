 ...
 * 2022-04-22T18:58:31.137-03:00
 * Generated source version: 2.7.13
 * 
 */
@WebServiceClient(name = "EstoqueWSService", 
                  wsdlLocation = "file:/home/ist-sd/dev/work/java/estoquewsWeb/src/EstoqueWSServiceCap5.wsdl",
...
public class EstoqueWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/ist-sd/dev/work/java/estoquewsWeb/src/EstoqueWSServiceCap5.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EstoqueWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/ist-sd/dev/work/java/estoquewsWeb/src/EstoqueWSServiceCap5.wsdl");
        }
        WSDL_LOCATION = url;
    }
